# Generated by Powerlevel10k configuration wizard on 2020-02-23 at 16:33 CET.
...
() {
  ...
  # Show only version (hide virtualenv name)
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_ICON='C'
